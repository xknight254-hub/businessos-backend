"""Sale (sales) repository (M3.2).

Encapsulates all sale/sale-item/payment DB primitives. Business
orchestration (totals, inventory decrement, customer stats) stays in
the router/service; this layer only touches the DB.
"""
